    ...
    def build(self,
        ...
        if word_dim:
            ...
            if pre_emb and training:
                ...
                print(c_found, c_lower, c_zeros, n_words)
                print('{0} / {1} ({2:.4f}) words have been initialized with pretrained embeddings.'.format(c_found + c_lower + c_zeros, n_words, 100. * (c_found + c_lower + c_zeros) / n_words))
